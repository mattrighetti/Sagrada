...
public class CopperFoilBurnisher extends ToolCard {
    ...
    public void action(GameManager gameManager) {
        try {
            ...
            gameManager.getCurrentRound().getCurrentPlayer().getUserObserver().sendResponse(new CopperFoilBurnisherResponse(patternCard.computeAvailablePositionsNoValue(gameManager.getDraftedDice())));
